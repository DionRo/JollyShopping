            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
                ...
                <tr>
                    <td align="center" valign="top"  bgcolor="#30373b" class="em_aside">
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
                            <tr>
                                <td align="center"><h1 style="color:gold;">OPGELET! {{$newsletter->title}}</h1></td>
                            </tr>
                            <tr>
                                <td align="center"><a href="https://jollyshopping.nl" target="_blank" style="text-decoration:none;"><img src="{{asset('img/logo.png')}}" width="230" height="150px" style="display:block;font-family: Arial, sans-serif; font-size:15px; line-height:18px; color:#30373b;  font-weight:bold;" border="0" alt="LoGo Here" /></a></td>
                            </tr>
                            <tr>
                                <td align="center"><h3 style="color:gold;">NIEUWSBRIEF #{{$newsletter->id}}</h3></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:18px; color:#30373b; text-transform:uppercase; font-weight:bold;" class="em_font">
                        <a href="https://jollyshopping.nl" target="_blank" style="text-decoration:none; color:#30373b;">home</a> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; <a href="https://jollyshopping.nl/products" target="_blank" style="text-decoration:none; color:#30373b;">Catalogus</a><span class="em_hide"> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; </span><span class="em_br"></span><a href="https://jollyshopping.nl/contact" target="_blank" style="text-decoration:none; color:#30373b;">Contact</a> &nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
                <!-- === //NAVIGATION SECTION === -->
                ...
                <tr>
                    <td valign="top" class="em_aside">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; font-weight:bold; line-height:18px; color:#30373b;">Hey Hoi! {{$user->firstname}} {{$user->lastname}}</td>
                            </tr>
                            <tr>
                    ...
                    <td valign="top" align="center">
                        <table border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                                <td height="36" class="em_height">&nbsp;</td>
                                <td align="center">
                                    <p style="color: #FFFFFF;">Wilt u lever geen nieuwsbrieven meer ontvangen klik dan <a style="color: gold;" href="https://jollyshopping.nl/unsubscribe/{{$user->email}}/{{$user->securityToken}}">hier</a></p>
                                </td>
                                <td height="36" class="em_height">&nbsp;</td>
                            </tr>
                        </table>
