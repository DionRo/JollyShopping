                ...
                <ul>
                    @foreach($products as $product)
                        <li class="new-product align-center">
                            ...
                            @endif
                            <form class="view-product" method="get" action="@if(isset($product->gender)){{action('clothingController@show', $product->id)}} @else {{action('accessoriesController@show', $product->id)}} @endif">
                                {{csrf_field()}}
